...
(function(c) {
    ...
    c.extend(h.prototype, {
                ...
                update: function(b, c) {
                    ...
                    for (b in d)
                        ...
                        case "icon":
                            ...
                            "class" == a.settings.icon_type.toLowerCase() ? f.removeClass(a.settings.content.icon).addClass(d[b]) : (f.is("img") || f.find("img"),
                            f.attr("src", d[b]));
                            break;
                        case "progress":
        ...
        placement: function() {
            var a = this
              ...
              , d = !1
              , f = this.settings;
            c('[data-notify-position="' + this.settings.placement.from + "-" + this.settings.placement.align + '"]:not([data-closing="true"])').each(function() {
            ...
            1 == this.settings.newest_on_top && (b = parseInt(b) + parseInt(this.settings.spacing) + this.$ele.outerHeight(),
            this.reposition(b));
        ...
        bind: function() {
            ...
            if (0 < this.settings.delay) {
                ...
                var b = setInterval(function() {
                    var c = parseInt(a.$ele.data("notify-delay")) - a.settings.timer;
                    ...
                    c <= -a.settings.timer && (clearInterval(b),
                    a.close())
                }, a.settings.timer)
            }
        },
    ...
    c.notifyClose = function(a) {
        "undefined" === typeof a || "all" == a ? c("[data-notify]").find('[data-notify="dismiss"]').trigger("click") : c('[data-notify-position="' + a + '"]').find('[data-notify="dismiss"]').trigger("click")
    }
});
